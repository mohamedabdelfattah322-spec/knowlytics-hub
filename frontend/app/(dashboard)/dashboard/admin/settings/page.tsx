...
import { Loader2, Eye, EyeOff, Lock, CheckCircle, User, Shield } from 'lucide-react';
      ...
      <div className="card">
        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="flex justify-between items-center py-2">
            <span className="text-slate-400">{t('settings.role')}</span>
            <span className="text-brand-400 font-semibold capitalize">{user?.role}</span>
          </div>
        </div>
      </div>
